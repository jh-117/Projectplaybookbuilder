  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      {/* FIX: Changed 'overflow-hidden' to 'overflow-y-auto' to allow scrolling.
          Increased 'max-h' to 95vh for better screen utilization. 
      */}
      <DialogContent className="max-w-4xl w-[95vw] max-h-[95vh] overflow-y-auto flex flex-col bg-gradient-to-br from-black via-gray-900 to-gray-950 border-2 border-gray-700 p-0">
        
        {/* FIX: Changed button to 'sticky' so it stays visible while scrolling the content */}
        ...
        <div className="flex-1 py-6 px-4 md:px-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto relative">
            ...
            {/* Row Divider Arrows for Desktop */}
          ...
          <div className="mt-16 pt-8 border-t border-gray-800">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
              <button
                ...
                className="flex flex-col items-center text-center p-4 md:p-6 bg-gray-800/40 rounded-2xl hover:bg-gray-700 border-2 border-cyan-500/50 hover:border-cyan-400 transition-all cursor-pointer shadow-lg"
              >
              ...
              <div className="flex flex-col items-center text-center p-4 md:p-6 bg-gray-900/20 rounded-2xl border-2 border-gray-800 opacity-40">
